...
def get_55_shen_sha(bazi, pillar_idx):
    ...
    if pillar_idx != 0 and t_b == hg_map.get(y_b): found.append("華蓋") # 年支查月日時
    if pillar_idx != 2 and t_b == hg_map.get(d_b): # 日支查年月時
